...
<body>
    <div id="overflow">
      <nav>
            <a id="logo" href='<?php echo ( "../loggedIn/homepage.php?id=".$userId);?>'> <img class="logo" src="../images/logos/fumitory-logo.png"  style="height: 100%;"></a>
        ...
        <div id="content">
            <div class="leftBox">
                <br>
                <br>
                <h1 class="noSpace">Lorem Ipsum Biordo Cured</h1>
                <p>Lorem </p>
