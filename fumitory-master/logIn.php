...
<body>
    <div id="overflow">
        ...
        <div id="contentTwo">
            ...
            if($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                die("<script>window.location.replace('loggedIn/homepage.php?id=".$userId."')</script>");  
                }
                else{
                    $userNone = true;
                };
    ...
    <script>
        var passview = false;
       var filled = false;
        document.getElementsByClassName("confirm")[0].disabled = true;document.getElementById("PWClick").addEventListener("mousedown", function () {
            if (passview == true) {
